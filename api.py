...
async def root():
    return {
        ...
        "endpoints": {
            ...
            "POST /extract": "Upload a PDF file to extract rate data (uses default configuration)",
            "POST /extract-range": "Upload a PDF file and extract rate data from specific page range (uses default configuration)",
